...
## Code
The code is written in Python, and the MNIST dataset (in original data format) is included in this repo under ./dataset. To run the demo which does training and testing in a row, run:
```bash
cd code
python3 SLLDA 
```
